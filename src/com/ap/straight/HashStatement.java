...
public class HashStatement implements Statement
{
    ...
    HashStatement(HashConnection conn)
    {
        this.conn = conn;
    }
    ...
    private void insertStatement(String sql, String uc_sql) throws SQLException
    {
        ...
        if (i == -1)
        {
            throw new SQLException("INSERT statement syntax error, missing ( after table name");
        }
        ...
        {
            throw new SQLException("INSERT statement syntax error, trailing caracters after )");
        }
